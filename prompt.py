...
1.姓名是该角色的唯一标识，你要提取出最具有代表的名称来指代该角色。有时文本中不会提及角色的具体姓名，会使用“我”、“他”、“男子”等代词来指代角色，这时你需要根据上下文和角色的特征来推测出最合适的名称，例如“教师”，“白衣男子”等，姓名可以使用中文、英文小写字母、数字和下划线来组成，如果名称中有特殊字符，请进行转化。
2.一个客观意义上的人因为年龄的增长，会有不同的角色，你需要在某人年龄大幅变化时，提取出一个新的角色，例如“张三”在小说中是一个小学生，后来长大成人了，这时你只需要提取出一个新的角色“张三_成年”，并进行成年张三的描写，不需要修改原本的小学生张三的信息。
